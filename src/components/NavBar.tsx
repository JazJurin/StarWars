  ...
  return (
    <div className="navbar flex items-start justify-between">
      ...
      <div className="navbar-center">
        <img src={logo} className="w-72 mx-auto my-auto" />
      </div>
      <div className="navbar-end">
        <Link to="/Register" className="btn btn-ghost btn-circle m-5">
          REGISTER
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
        ...
        <Link to="/Login" className="btn btn-ghost btn-circle m-5">
          LOGIN
